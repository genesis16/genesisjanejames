    ...
    if ( instant_ide_validate_token( $_POST['token'] ) ) {
        ...
        if ( empty( $form_errors ) ) {
            ...
            if ( false === $locked_out ) {
                ...
                if ( array_key_exists( $user, $iIDE_USERS ) ) {
                    ...
                    if ( password_verify( $password, $iIDE_USERS[$user] ) ) {
                        ...
                        if ( $login_failures > 5 ) {
                            ...
                            Swal.fire(\'Error\', \'You have entered an invalid password. You have also exceeded 5 failed login attempts in less than 15 minutes. Therefore you are locked out for the next 15 minutes.\', \'error\');
                            </script>';
                            
                        } else {
                            
                            $result = '<script type="text/javascript">
                            Swal.fire(\'Error\', \'You have entered an invalid password.\', \'error\');
                            </script>';
                    ...
                    if ( $login_failures > 5 ) {
                        ...
                        $result = '<script type="text/javascript">
                        Swal.fire(\'Error\', \'You have entered an invalid username. You have also exceeded 5 failed login attempts in less than 15 minutes. Therefore you are locked out for the next 15 minutes.\', \'error\');
                        </script>';
                        
                    } else {
                        
                        $result = '<script type="text/javascript">
                        Swal.fire(\'Error\', \'You have entered an invalid username.\', \'error\');
                        </script>';
                ...
                $result = '<script type="text/javascript">
                Swal.fire(\'Error\', \'You are currently locked out due to too many failed login attempts! Try again in about 15 minutes.\', \'error\');
                </script>';
        ...
        //throw an error
        $result = '<script type="text/javascript">
        Swal.fire(\'Error\', \'This request originates from an unknown source.\', \'error\');
        </script>';
