...
if ( isset( $_POST['deleteUserBtn'], $_POST['token'] ) ) {
    ...
    if ( instant_ide_validate_token( $_POST['token'] ) ) {
        ...
        //display error
        $result = '<script type="text/javascript">
                    Swal.fire(\'Form Validation Error\', \'Please try again...\', \'error\' );
                    </script>';
...
<div class="instant-ide-login-form-container instant-ide-setup-form-container">
	...
	<form method="post" action="">
	    <p>
	    	...
	    	<input type="submit" name="deleteUserBtn" value="Delete Account" onClick='return confirm("Are you sure you want to delete this Instant IDE User Account?")'>
