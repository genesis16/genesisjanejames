<?php
/*
 * Build the login header template file.
 */
?>
...
<head>
    ...
    <title>Instant IDE - Login</title>
    
    <link rel="shortcut icon" href="<?php echo IIDE_URL; ?>assets/css/images/favicon.ico" type="image/x-icon" />
    <link rel="stylesheet" href="<?php echo IIDE_URL; ?>assets/css/style-login.css?ver=<?php echo IIDE_VERSION; ?>">
