...
add_filter( 'woocommerce_enqueue_styles', 'genesis_jane_james_woocommerce_styles' );
/**
 ...
 */
function genesis_jane_james_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'genesis_jane_james_woocommerce_css' );
/**
 ...
 */
function genesis_jane_james_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'genesis_jane_james_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'genesis_jane_james_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		genesis_jane_james_color_contrast( $color_accent )
	) : '';
